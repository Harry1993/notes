...
discussion. To unmount, run `fusermount -uz ./mountpoint`. If forget to unmount before go to sleep, run `sudo diskutil umount force [mountpoint]` (See [this discussion](https://github.com/osxfuse/osxfuse/issues/45)).
